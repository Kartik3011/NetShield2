...
# =========================================================================
# NEWSAPI CONFIGURATION (Using a placeholder key for deployment example)
# NOTE: You MUST replace this key with your actual NewsAPI key.
NEWS_API_KEY = st.secrets["NEWS_API_KEY"]  # <-- IMPORTANT: Replace this placeholder
